...
BEGIN
    ...
    ASSERT row_count=793, 'FAILED: the_office_wpl table did not have 793 inserted rows.';

    /* Spot check a record and verify it has the correct values. */
    SELECT * INTO test_row_1 FROM the_office_wpl WHERE id = 23;
    ASSERT test_row_1.office_character = 'Mark', 'FAILED: ASSERT test_row_1.office_character';
